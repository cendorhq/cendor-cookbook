...
The 2026-07-27 npm shelf. All `@cendor/*` libraries share **major 3**; minors and patches are
independent per package, which is why `@cendor/contextkit` is `3.0.1` and `@cendor/acttrace` is
`3.1.0`.
